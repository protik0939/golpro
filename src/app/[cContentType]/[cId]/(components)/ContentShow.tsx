...
export default function ContentShow({ cId }: CIdProps) {
        ...
        return (
            <div>
                ...
                <div className='w-full overflow-hidden'>
                    ...
                    {/* Season Carousel Placeholder */}
                    <div className="flex flex-wrap justify-start gap-4 p-5 w-[4000px]">
                        <div className="w-[2%] md:w-[5%] aspect-square skeletonLoaderBg animate-pulse rounded-lg"></div>
                        <div className="w-[2%] md:w-[5%] aspect-square skeletonLoaderBg animate-pulse rounded-lg"></div>
                        <div className="w-[2%] md:w-[5%] aspect-square skeletonLoaderBg animate-pulse rounded-lg"></div>
                        <div className="w-[2%] md:w-[5%] aspect-square skeletonLoaderBg animate-pulse rounded-lg"></div>
                        <div className="w-[2%] md:w-[5%] aspect-square skeletonLoaderBg animate-pulse rounded-lg"></div>
    ...
    return (
        <div>
                        ...
                        <div className='flex flex-col'>
                            ...
                            {aLoading ? (
                                <div className="flex -space-x-6">
                                    {[...Array(3)].map((_, index) => (
                                        <div key={index} className="w-12 h-12 rounded-full skeletonLoaderBg animate-pulse" />
                                    ))}
                                </div>
                            ) : (
            ...
            <SeasonsCarousal title="Seasons" slidesInfo={content.cSeasons} contentType={content.cContentType} contentId={content.cId} />
            <AuthorsCarousal title="Authors" slidesInfo={authors} />
        </div>
    );
}
