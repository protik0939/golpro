                            ...
                            return (
                                <div key={content.cTitle}
                                    ...
                                    <div className="relative md:m-2 m-[2px] group-hover:z-30 flex flex-col items-center">
                                        ...
                                        <div className=" w-full absolute bottom-0 md:p-3 p-2 flex flex-col md:group-hover:items-start items-end md:group-hover:animate-slideIn cards-bg w-full rounded-b-xl">
